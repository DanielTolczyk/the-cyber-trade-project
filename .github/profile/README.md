...
## Restructuring Cybersecurity into a Recognized Skilled Trade

The Cybersecurity Trade Project is an open-source framework, technical specification, and governance standard that restructures cybersecurity from an unstructured corporate job into an accredited skilled trade. 

Modeled after established licensed professions (such as aviation, maritime defense, and electrical engineering), the trade architecture replaces fragmented vendor certifications, non-standardized titles, and predatory bootcamps with registered apprenticeships, verifiable operational runtime ledgers, objective hands-on challenge exams, professional licensure, and legal protections.
...
## Interactive Ecosystem Web Applications

* **[Specification Documentation Portal](https://the-cyber-trade-project.github.io/framework/):** Comprehensive specifications, governance bylaws, operational field roles, and procedural forms.
* **[Career Tier & Prior Learning Estimator](https://the-cyber-trade-project.github.io/estimator/):** Privacy-first client-side evaluation engine calculating provisional trade tier placement, grandfathering credits, and wage milestones.
* **[Universal Digital Logbook PWA](https://the-cyber-trade-project.github.io/logbook/):** Offline-first cryptographic runtime ledger supporting WebCrypto AES-256-GCM vault security, FIDO2/WebAuthn supervisor attestations, and actuarial audit exports.

---

## Active Repositories

* **[the-cyber-trade-project](https://github.com/the-cyber-trade-project/framework):** Core framework specifications, governance charters, procedural templates, and interactive portal.
* **[estimator](https://github.com/the-cyber-trade-project/estimator):** Single-page application and mathematical evaluation engine for trade tier and PLA calculations.
* **[logbook](https://github.com/the-cyber-trade-project/logbook):** Universal digital ledger Progressive Web App and cryptographic validation CLI.

---

## Licensing & Governance

The specifications and governance documentation are dual-licensed under **Creative Commons Attribution-ShareAlike 4.0 International (CC BY-SA 4.0)** and **Apache License 2.0**.
