...
+─────────────────────────────────────────────────────────────────────────────+
  │
  ├─► SEAT 1: PRIMARY CYBER LIABILITY UNDERWRITER (1 Seat)
  │   • Selection: Elected by participating primary cyber insurance carriers
  │     via Instant-Runoff Ranked-Choice Voting (RCV).
  │   • Focus: Commercial policy warranty schedules, enterprise rate credits
  │     (25% to 35%), deductible reductions, and prima facie claim defensibility.
  │
  └─► SEAT 2: ACTUARIAL & SYSTEMIC REINSURANCE SPECIALIST (1 Seat)
      • Selection: Designated by the Casualty Actuarial Society (CAS) or
        participating global reinsurance syndicates (e.g., Munich Re, Swiss Re).
      • Focus: Empirical loss prevention curves, systemic catastrophic modeling,
