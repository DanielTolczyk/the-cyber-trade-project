...
## 1. Core Generalist Foundation (Mandatory for Tiers 1–2)
Before pursuing specialty endorsements, all apprentices must log validated operational hours across four foundational pillars:
...
### Branch E: Application Security & Secure Software Supply Chain (AppSec)
* **Core Focus:** Secure SDLC integration, SAST/DAST/SCA tooling, API security, Software Bill of Materials (SBOM) integrity, and OWASP ASVS/SAMM frameworks.
* **Illustrative Examples / Equivalencies:** CASE, CSSLP, specialized web application security credentials.
* **Sign-off Authority:** Production software security release clearance, SBOM compliance verification.

### Branch F: Medical Device & Clinical IoT Security (IoMT)
* **Core Focus:** Embedded device security, FDA 524B pre-market readiness, clinical network segmentation, secure boot mechanisms, and device lifecycle management.
* **Illustrative Examples / Equivalencies:** Biomedical engineering cybersecurity specializations, embedded systems security credentials.
* **Sign-off Authority:** Pre-market FDA cybersecurity readiness sign-off, clinical network deployment clearance.
...
## 3. Endorsement Stacking & Continuing Maintenance
