...
To graduate as a Licensed Journeyman, an apprentice must log a minimum of **8,000 verified operational runtime hours** under the direct line-of-sight supervision of a Licensed Journeyman or Master Practitioner. 
...
> **Rotational Flexibility:** Up to 1,000 hours may be allocated as elective focus hours in an approved Specialty Track (e.g., ICS/SCADA, MedTech, or DFIR) during Apprentice Tier 4.

---

## 2. Related Technical Instruction (RTI) Requirements

Apprentices must complete a minimum of **144 classroom/lab hours per year** (576 total RTI hours over the 4-year term). 
...
* Challenge evaluations consist of live-fire, 24-hour scenario labs (defensive hardening, threat containment, and triage under pressure) evaluated by a panel of Licensed Masters.

### B. Prior Learning Assessment (PLA) Credit Limits
Prior operational experience and verified skill benchmarks translate to OJT hour credits according to standardized conversion caps:
...
Apprentices must maintain an immutable, cryptographic or signed physical **Operational Logbook** recording:

1. Hourly distribution across the 5 core rotational domains.
2. Verified incidents triaged, systems hardened, and changes audited.
3. Bi-weekly review signatures from the supervising Journeyman or Master of Record.
4. Quarterly evaluations submitted to the regional Joint Apprenticeship and Training Committee (JATC) for wage tier advancement.