...
* **Operational Safeguard:**
  ...
  4. **Trustee Plan Document Governance Boundary:** To prevent political pressure from creating unfunded liabilities, specific benefit accrual unit values, hurdle rates, retirement age gates, and actuarial annuity conversion schedules are legally delegated to the 50/50 Bipartisan Board of Trustees via the *Taft-Hartley Summary Plan Description (SPD)*, certified triennially by independent Enrolled Actuaries (EA/FSA) pursuant to ERISA Section 103.
